          ...
          <div class="card-content">
            <div class="columns">
              ...
              <div class="column is-narrow">
                <div class="field">
                  <div class="control">
                    <button class="button is-medium" :class="{ 'is-active': viewMode === 'grid' }" @click="viewMode = 'grid'">
                      <span class="icon">
              ...
              <div class="column is-narrow">
                <div class="field">
                  <div class="control">
                    <button class="button is-medium" :class="{ 'is-active': viewMode === 'list' }" @click="viewMode = 'list'">
                      <span class="icon">
              ...
              <div class="card-content">
                <div class="media">
                  ...
                  <div class="media-content">
                    <p class="title is-4 has-text-white">{{ totalCustomers }}</p>
            ...
            <div class="card stats-card has-background-success">
              <div class="card-content">
                <div class="media">
                  ...
                  <div class="media-content">
                    <p class="title is-4 has-text-white">{{ newCustomersThisMonth }}</p>
                    <p class="subtitle is-6 has-text-white-bis">New This Month</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card stats-card has-background-warning">
              <div class="card-content">
                <div class="media">
                  ...
                  <div class="media-content">
                    <p class="title is-4 has-text-white">{{ activeCustomers }}</p>
                    <p class="subtitle is-6 has-text-white-bis">Active Customers</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="container">
        ...
        <div v-else-if="filteredCustomers.length === 0" class="has-text-centered py-6 px-4">
          <div class="has-text-centered py-6">
            ...
            <router-link to="/customers/new" class="button is-primary is-medium" v-if="!searchQuery">
              <span class="icon">
                <i class="fas fa-plus"></i>
              </span>
            ...
            <div class="card customer-card">
              <div class="card-content">
                <div class="media">
                  ...
                  <div class="media-content">
                    <p class="title is-6 mb-1">{{ customer.first_name }} {{ customer.last_name }}</p>
                    <p class="subtitle is-7 has-text-grey">{{ customer.email || 'No email' }}</p>
                  </div>
                </div>
              ...
              <footer class="card-footer">
                <router-link :to="`/customers/${customer.id}`" class="card-footer-item">
                  <span class="icon">
                    <i class="fas fa-eye"></i>
                  </span>
                  <span>View</span>
                </router-link>
                <router-link :to="`/customers/${customer.id}/edit`" class="card-footer-item">
                  <span class="icon">
              ...
              <table class="table is-fullwidth is-hoverable">
                ...
                <tbody>
                  <tr v-for="customer in paginatedCustomers" :key="customer.id">
                    <td>
                      <div class="media">
                        ...
                        <div class="media-content">
                          ...
                          <br>
                          <small class="has-text-grey">ID: {{ customer.id }}</small>
                        </div>
                      </div>
                    </td>
                    <td>
                    ...
                    <td>
                      <p v-if="customer.address">{{ customer.address.length > 40 ? customer.address.substring(0, 40) + '...' : customer.address }}</p>
                      <span v-else class="has-text-grey">No address</span>
                    </td>
                    <td>
                      <span class="tag is-info">{{ customer.loan_count || 0 }} loans</span>
                    </td>
                    <td>
